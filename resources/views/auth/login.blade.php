...
<head>
    ...
    <title>Login | Sistem KP PCR</title>
    <meta name="description" content="Login Sistem Kerja Praktik PCR" />
            ...
            <div class="authentication-inner">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4 text-center">Silakan login menggunakan akun resmi PCR</p>
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ route('login.post') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" class="form-control" id="email" name="email"
                                    placeholder="contoh: nama@pcr.ac.id" autofocus required />
                            </div>
